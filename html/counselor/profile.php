...
<html lang="en">
  <head>
    ...
    <title>Counselor Profile - Guidance Counseling System</title>
    <link
  ...
  <body>
        ...
        <div class="profile-body">
          ...
          <div id="viewMode">
            <div class="d-flex justify-content-between align-items-center mb-4">
              <h4 class="mb-0">Counselor Information</h4>
            ...
            <div class="row g-4">
              ...
              <div class="col-md-6">
                ...
                <div class="info-value" id="viewSpecialization">--</div>
              </div>
              <div class="col-md-6">
    ...
    <script>
        ...
        function updateView() {
            ...
            document.getElementById('viewSpecialization').textContent = profileData.specialization;
        ...
        function enableEdit() {
            ...
            document.getElementById('editSpecialization').value = profileData.specialization;
